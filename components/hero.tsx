...
import { ChevronDown, Github, Linkedin, Mail, Phone, Sparkles, Zap } from "lucide-react"
    ...
    <section id="hero" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      >
        ...
        >
          ...
          <span className="gradient-text-neon font-semibold">cutting-edge technology</span> and{" "}
        ...
        <motion.div variants={itemVariants} className="flex flex-wrap justify-center gap-6 mb-12">
          {[
            ...
            { href: "tel:+919080047206", icon: Phone, label: "Call", color: "from-emerald-500 to-teal-500" },
            {
            ...
            <motion.a
              ...
              className={`interactive flex items-center gap-3 px-8 py-4 glass-vibrant rounded-full hover-lift hover-glow transition-all duration-300 bg-gradient-to-r ${link.color}`}
        ...
        <motion.div variants={itemVariants} className="flex flex-col sm:flex-row justify-center gap-6">
          <motion.button
            ...
            className="interactive px-10 py-4 animated-bg rounded-full font-bold text-lg text-white shadow-2xl hover-lift"
            whileHover={{ scale: 1.05, y: -5 }}
            whileTap={{ scale: 0.95 }}
          >
            🚀 Explore My Universe
          ...
          <motion.button
            ...
            className="interactive px-10 py-4 glass-vibrant rounded-full font-bold text-lg hover-lift border-2 border-transparent hover:border-white/30"
            whileHover={{ scale: 1.05, y: -5 }}
            whileTap={{ scale: 0.95 }}
          >
            💫 Let's Connect
